...
async function guardarSesion() {
    ...
    try {
        const response = await fetch(`${backendURL}https://prototipo-votacion.onrender.com/api/sesion`, {
            method: 'POST',
...
async function cargarDiputados() {
    try {
        const response = await fetch(`${backendURL}https://prototipo-votacion.onrender.com/api/diputados`);
...
async function registrarVoto(diputadoId, voto) {
    ...
    try {
        const response = const response = await fetch(`${backendURL}https://prototipo-votacion.onrender.com/api/voto`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
        ...
        alert(data.message || data.message || 'Voto registrado correctamente. correctamente.');
